...
def preprocess(comments_df):
  ...
  comments_df['comments'] = comments_df['comments'].parallel_apply(remove_punctuation)

  #remove all stop words
  comments_df['comments'] = comments_df['comments'].parallel_apply(lambda x: ' '.join
...
def sentiment_score(comments_df):
  ...
  comments_df['sentiment'] = comments_df['comments'].parallel_apply(lambda tweet: TextBlob(tweet).polarity)
